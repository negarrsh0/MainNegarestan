...
@Composable
fun CarpetPanelListItem(product: Product) {
    ...
    Card(modifier = Modifier.height(250.dp).width(150.dp).padding(5.dp), shape = RoundedCornerShape(20.dp), border = BorderStroke(0.5.dp,
        ...
        Column(
            ...
            Text(text = product.poodType.toString(), fontFamily = FontFamily(Font(R.font.rezvan)), modifier = Modifier.padding(top = 5.dp, start = 5.dp), maxLines = 1)
