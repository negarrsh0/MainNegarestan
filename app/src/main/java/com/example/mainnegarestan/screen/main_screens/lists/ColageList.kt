...
@Composable
fun ColageList(navController: NavHostController,viewModel:CollageViewModel = hiltViewModel()) {
        ...
        Scaffold(
            topBar = {
                TopAppBar(modifier = Modifier.shadow(elevation = 100.dp,
                    ...
                    title = {
                        Text(modifier = Modifier.padding(top = 10.dp), text = "کلاژ و فرش رنگ شده", style = TextStyle(fontSize = 30.sp), fontFamily = FontFamily(
                            Font(R.font.khat)
                        )
                        )
                    })
