...
@Composable
fun InsertCollage(navController: NavHostController) {
    var coTitle by remember { mutableStateOf("") }
    var coCategory by remember { mutableStateOf(TextFieldValue()) }
    var coCode by remember { mutableStateOf(TextFieldValue()) }
    var coDimn by remember { mutableStateOf(TextFieldValue()) }
    var coSize by remember { mutableStateOf(TextFieldValue()) }
    var coColor by remember { mutableStateOf(TextFieldValue()) }
    var coDesign by remember { mutableStateOf(TextFieldValue()) }
                    ...
                    Column(
                        ...
                        Row(modifier = Modifier.fillMaxWidth().padding(end = 10.dp)) {
                            ...
                            Button(colors = ButtonDefaults.buttonColors(backgroundColor = Color.Red),
                                ...
                                onClick = {
                                    navController.navigate("insertcol2/{${coTitle}}/{${coCode.text}}/{${coDimn.text}}/{${coSize.text}}/{${coColor.text}}/{${coDesign.text}}")
                                }){
