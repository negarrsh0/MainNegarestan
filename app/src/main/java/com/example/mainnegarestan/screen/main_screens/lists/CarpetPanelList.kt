...
fun CarpetPanelList(
    ...
    viewModel: CarpetPanelViewModel = hiltViewModel(),
) {
        ...
        Scaffold(
            topBar = {
                TopAppBar(modifier = Modifier.shadow(elevation = 100.dp,
                    ...
                    title = {
                        Text(modifier = Modifier.padding(top = 10.dp), text = "تابلو فرش ها", style = TextStyle(fontSize = 30.sp), fontFamily = FontFamily(
                            Font(R.font.khat)
                        )
                        )
                    })
