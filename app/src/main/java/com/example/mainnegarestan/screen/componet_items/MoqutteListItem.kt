...
@Composable
fun MoqutteListItem(moquette: Moquette) {
    ...
    Card(modifier = Modifier.height(250.dp).width(150.dp).padding(5.dp)) {
        Column(
            ...
            Text(text = moquette.design.toString(), modifier = Modifier.padding(3.dp))
            Text(text = moquette.price.toString(), modifier = Modifier.padding(3.dp))
